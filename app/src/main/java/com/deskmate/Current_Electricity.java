...
public class Current_Electricity {
    ...
    public static String GalvAsAmm(String a, String b, String c, String d) {

        double Ig = Double.parseDouble(a);
        double G = Double.parseDouble(b);
        double I = Double.parseDouble(c);
        double S = Double.parseDouble(d);

        if (a.equals("*")) {
            String res = String.valueOf(Double.parseDouble(df.format((I*S)/(G+S)) + " Ohm "));
            if (res.contains("E")) {
                return (expConverter(res));
            } else {
                return (res);
            ...
            String res = String.valueOf(Double.parseDouble(df.format(((I - Ig)*S) /Ig)) + " Ohm ");
            if (res.contains("E")) {
                return (expConverter(res));
            } else {
                return (res);
            ...
            String res = String.valueOf(Double.parseDouble(df.format((Ig*(G+S))/S)    + " Ohm "));
            if (res.contains("E")) {
                return (expConverter(res));
            } else {
                return (res);
            ...
            String res = String.valueOf(Double.parseDouble(df.format((Ig*G)*(I-Ig)) + " Ohm "));
            if (res.contains("E")) {
                return (expConverter(res));
            } else {
                return (res);
